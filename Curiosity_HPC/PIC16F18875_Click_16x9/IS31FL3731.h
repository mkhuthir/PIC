...
/**
IS31FL3731      Click       Curiosity HPC
-------------------------------------
...
void InitIS31FL3731(void);                                          // initialize device
#define HWShut() CS_Setlow();                                       // Hardware shutdown
#define HWNoShut() CS_SetHigh();                                    // Hardware no shutdown
